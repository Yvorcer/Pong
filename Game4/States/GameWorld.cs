...
namespace Game4
{
    class GameWorld
    {
        ...
        public GameWorld(ContentManager Content)
        {
            ...
            paddleR = new Paddle(Content, (int)Pong.Screen.X - 15, (int)startPaddlePos.Y, Keys.Up, Keys.Down, Color.Red);
        ...
        private void DrawUI(SpriteBatch spriteBatch)
        {
            ...
            // Check if one of the players has won or lost.
            else if (ball.LivesL == 0 || ball.LivesR == 0)
            {
                ...
                if (ball.LivesR > 0) // Find out which player has won.
        ...
        private void OnCollission()
        {
            ...
            {
                Pong.PaddleHit.Play(); // Play sound to confirm collission.
        ...
        public void Reset() // Reset all GameObject and Score back to the beginning
        {
            ball.LivesL = 3;
            ball.LivesR = 3;
